  ...
  _createClass(Service, [{
    ...
    value: function _find() {
      ...
      if (query.$or) {
        (function () {
          ...
          query.$or.forEach(function (queryObject, i) {
          ...
          q = q.filter(orQuery);
          query = (0, _lodash2.default)(query, '$or');
        })();
      }
      q = (0, _parse2.default)(this, q, query);
    ...
    value: function update(id, data) {
      ...
      return this._get(id).then(function (getData) {
        data[_this2.id] = id;
        return _this2.table.get(getData[_this2.id]).replace(data, {
          returnChanges: true
